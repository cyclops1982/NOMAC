<?php
/*
Plugin Name: Google Calendar Events - EDITED by Ruben d'Arco for NOMAC!
Plugin URI: http://www.rhanney.co.uk/plugins/google-calendar-events
Description: Parses Google Calendar feeds and displays the events as a calendar grid or list on a page, post or widget. This has been edited by Ruben to make the stylesheets work like we want to.
Version: 0.7.1
Author: Ross Hanney
